...
protect is the contract hub-api's chat agent depends on — the four tools exist,
they are the *only* four, `CubeQuery` validation still happens on our side of
the wire, and the bearer wall is on by default.
"""
